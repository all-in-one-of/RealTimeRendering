...
// enable multisampling for smoother drawing
  ...
  //load in custom models
  m_rightglass.reset( new ngl::Obj("/home/s4906706/Documents/PoR/RealtimeRendering/models/RightGlass.obj","models/Dark.png"));
  m_rightglass->scale(0.2,0.2,0.2);
  m_rightglass->createVAO();

  m_leftglass.reset( new ngl::Obj("/home/s4906706/Documents/PoR/RealtimeRendering/models/LeftGlass.obj","models/Dark.png"));
  m_leftglass->scale(0.2,0.2,0.2);
  m_leftglass->createVAO();
}
...
void NGLScene::paintGL()
{
  ...
  prim->createTrianglePlane("plane",10,10,3,3,ngl::Vec3(1,1,0));
  // draw
